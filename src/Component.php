...
class Component extends BaseComponent
{
    ...
    protected const COMPONENT_NAME = "Validators package";
    protected const COMPONENT_URL = 'https://validators.packages.guzaba.org/';
    ...
    protected const ERROR_REFERENCE_URL = 'https://github.com/AzonMedia/validators/docs/ErrorReference/';
}